...
const App = () => {
  ...
  const handleLogout = () => {
    ...
    // buena práctica, por si acaso se están guardando un montón de datos de la usuaria. Limpia los datos
  ...
  return (
    <>
      <Header />
      {/* Al negarlo dos veces se convierte en true, pasa de truthy o falsy. Sería igual a userId !== '' */}
      <User
...
// todo lo que devuelva el servidor se guarda en algún estado... en uno, en dos, en aguacate...
